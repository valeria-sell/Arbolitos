...
class Individual:
    ...
    def printTree(self):
        ...
        d_ram_angle = random.uniform(self.ram_angle[0] , self.ram_angle[1])
        d_line_len = random.uniform(self.line_len[0] , self.line_len[1])
        d_decrease_prop = int(random.uniform(self.decrease_prop[0] , self.decrease_prop[1]))
